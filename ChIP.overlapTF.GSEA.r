...
##################################read files
saminfo=read.csv("./data/1_CHP134/sample.combined.chip.csv")
anno=read.table("./data/1_CHP134/combined.all.reprodu.bed.anno",header = T)
d=read.table("./data/1_CHP134/all.counts.filter.data",header = T)
