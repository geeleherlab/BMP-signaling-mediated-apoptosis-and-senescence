...
##################################read files
saminfo=read.csv("./data/2_TGW/sample.combined.chip.csv")
anno=read.table("./data/2_TGW/RARA_SMAD4_combined.bed.anno",header = T)
d=read.table("./data/2_TGW/all.counts.filter.data",header = T)
